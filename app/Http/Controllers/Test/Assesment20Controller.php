...
class Assesment20Controller extends \App\Http\Controllers\Controller
{
    /**
    ...
    public static function detail($result)
    {
        ...
        // View
        return view('admin/result/assesment-20/detail', [
            'result' => $result,
    ...
    public static function print(Request $request)
    {
        ...
        // PDF
        $pdf = PDF::loadview('admin/result/assesment-20/pdf', [
            'result' => $result,
            'image' => $request->image,
            'name' => $request->name,
            'age' => $request->age,
