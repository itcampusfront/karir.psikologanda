...
class MagangController extends \App\Http\Controllers\Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        //             $internships[$key]->phone_number = $internship->attribute->phone_number;
        //             $internships[$key]->company_name = $internship->attribute->company->name;
        //             $internships[$key]->position_name = $internship->attribute->position ? $internship->attribute->position->name : '-';
        //         }
        //     }
    ...
    public function detail($id)
    {
        ...
        // View
        return view('admin/magang/detail', [
            'applicant' => $applicant,
            'selection' => $selection
        ]);
    }
