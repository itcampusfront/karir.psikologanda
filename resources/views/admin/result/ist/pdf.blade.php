...
<head>
	...
	<style>
	    ...
	    .deskripsi p {text-align: justify; margin-bottom: 4px; font-size: 10px;}
...
<body>
    ...
    <table width="100%" border="1" style="margin-top: 20px;">
        <tr>
			...
			{{--<td align="center">Tujuan Pemeriksaan : {{ $result->user->attribute->inspection }}--}}
        </tr>
    </table>
	<p class=""><strong>Tujuan Pemeriksaan :</strong> {{ $result->user->attribute->inspection }}</p>
	<table width="100%">
			<tr>
                <td align="center" valign="top">
				    <table class="table-bordered text-center" style="margin-top: 10px; margin-left: auto; margin-right: auto;">
			...
			<tr>
                 <td align="center" valign="top"><img src="{{ $chartImage }}" width="330"></td>
            </tr>
        </table>
</body>
</html>