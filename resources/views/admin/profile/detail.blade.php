            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        ...
                        <div>{{ $user->attribute->company->name }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>Kode Perusahaan:</div>
                        <div>{{ $user->attribute->company->code }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>Alamat Perusahaan:</div>
                        <div>{{ $user->attribute->company->address }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>No. Telp Perusahaan:</div>
                        <div>{{ $user->attribute->company->phone_number }}</div>
                    </li>
                    @endif
                </ul>
            </div>
