                    ...
                    <table class="table table-sm table-hover table-bordered" id="datatable">
                        ...
                        {{-- <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                     @if ($selection->user->role_id == 4)
                                        <a href="{{ route('admin.applicant.detail', ['id' => $selection->user_id]) }}">
											{{ ucwords($selection->user->name) }}</a>
                                    @elseif ($selection->user->role_id == 6)
                                        <a href="{{ route('admin.internship.detail', ['id' => $selection->user_id]) }}">
											{{ ucwords($selection->user->name) }}</a>
                                    @endif
                                    <br>
                                ...
                                <td align="center">
                                    <div class="btn-group">
                                        @if($selection->status == 1 && $selection->user->role_id != 3)
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <select id="result" name="result" class="form-select form-select-sm {{ $errors->has('result') ? 'border-danger' : '' }}">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url' : '{{ route('admin.selection.getData') }}',
                'data' : function(d){
                    d.company_select = $('#company').val();
                    d.test_select = $('#result').val();
                }
