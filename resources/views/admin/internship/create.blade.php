...
<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah Magang</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.internship.store') }}" enctype="multipart/form-data">
                    @csrf
					...
					<div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="inspection" class="form-control form-control-sm {{ $errors->has('inspection') ? 'border-danger' : '' }}" rows="3">{{ old('inspection') }}</textarea>
